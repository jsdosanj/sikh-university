...
// POST /api/progress { courseId, done:[...] } -> upsert lesson completion only.
// The quiz SCORE is never accepted here — it is set solely by /api/quiz, which
// grades on the server. This prevents a client from forging a grade/certificate.
